defmodule X12TranslatorWeb.Layouts do
  @moduledoc """
  ...
  This function is typically invoked from the app.html.heex template,
  and it contains your application menu, sidebar, and main content area.
    ...
    <header class="navbar px-4 sm:px-6 lg:px-8">
      <div class="flex-1">
        <a href="/" class="flex-1 flex w-fit items-center gap-2">
          ...
          <span class="text-sm font-semibold">X12Translator</span>
        </a>
      </div>
      <div class="flex-none">
