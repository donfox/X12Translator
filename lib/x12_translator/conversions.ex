defmodule X12Translator.Conversions do
  @moduledoc """
  ...
  def cleanup_old_batches(opts \\ []) do
    max_batches =
      Keyword.get(opts, :keep) ||
        Application.get_env(:x12_translator, :batch_retention)[:max_batches] ||
        50
  ...
  def process_batch_sync(batch_id, uploaded_files) do
    ...
    max_concurrency = Application.get_env(:x12_translator, :batch_max_concurrency, 8)
