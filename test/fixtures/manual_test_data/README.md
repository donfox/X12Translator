...
```bash
# Extract ZIP
unzip test/fixtures/x12/manual_test_data/databricks_batch_2026-01-09.zip -d /tmp/test_batch
...
test "processes large batch from archive" do
  archive_path = "test/fixtures/x12/manual_test_data/databricks_batch_2026-01-09.zip"
