defmodule X12Bridge.X12.Converter do
  ...
  alias X12Bridge.X12.Codes.EntityCodes
  alias X12Bridge.X12.Codes.DateQualifiers
  alias X12Bridge.X12.Codes.ReferenceQualifiers
  alias X12Bridge.X12.Codes.ClaimFilingIndicators
  alias X12Bridge.X12.Codes.PlaceOfService
  ...
  defp extract_claim(
    ...
    dates =
      ...
      |> Enum.map(fn dtp ->
        ...
        %{
          ...
          date_qualifier_desc: DateQualifiers.lookup(qualifier),
    ...
    references =
      ...
      |> Enum.map(fn ref ->
        ...
        %{
          ...
          reference_id_qualifier_desc: ReferenceQualifiers.lookup(qualifier),
    ...
    patient =
      if patient_nm1_segment do
        ...
        %{
          ...
          entity_id_code_desc: EntityCodes.lookup(entity_code),
    ...
    base_claim = %{
      ...
      claim_filing_indicator_desc: ClaimFilingIndicators.lookup(claim_filing_code),
  ...
  defp extract_professional_service_line(lx_segment, sv1, _line_segs, delimiters) do
    ...
    base_result = %{
      service_info: %{
        ...
        place_of_service_desc: PlaceOfService.lookup(place_of_service_code),
