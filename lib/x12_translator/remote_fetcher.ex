...
defmodule X12Translator.RemoteFetcher do
  @moduledoc """
  ...
  ## Example
      ...
      iex> X12Translator.RemoteFetcher.fetch_and_extract("https://example.com/batch.zip")
  ...
  ## Examples
      ...
      iex> X12Translator.RemoteFetcher.detect_source_type("https://example.com/file.zip")
      :http_url

      iex> X12Translator.RemoteFetcher.detect_source_type("/Users/name/file.zip")
      :local_zip

      iex> X12Translator.RemoteFetcher.detect_source_type("/Users/name/x12_files/")
      :local_directory

      iex> X12Translator.RemoteFetcher.detect_source_type("/Users/name/claim.x12")
      :local_x12_file

      iex> X12Translator.RemoteFetcher.detect_source_type("/mnt/data/x12/file.zip")
      :databricks_path
  ...
  defp get_sftp_config(sftp_url, opts) do
    ...
    env_config = Application.get_env(:x12_translator, :sftp, [])
  ...
  defp fetch_from_databricks(databricks_path, opts) do
    ...
    databricks_config = Application.get_env(:x12_translator, :databricks, [])
    ...
    cond do
      is_nil(host) or is_nil(token) ->
        ...
        config :x12_translator, :databricks,
  ...
  ## Examples
      ...
      iex> X12Translator.RemoteFetcher.validate_url("https://example.com/file.zip")
      {:ok, %URI{scheme: "https", host: "example.com", ...}}

      iex> X12Translator.RemoteFetcher.validate_url("ftp://example.com/file.zip")
      {:error, :invalid_url}
  ...
  ## Examples
      ...
      iex> X12Translator.RemoteFetcher.cleanup_temp_files("/tmp/x12bridge_remote_123")
      :ok
  ...
  defp get_config(opts) do
    app_config = Application.get_env(:x12_translator, :remote_fetcher, [])
