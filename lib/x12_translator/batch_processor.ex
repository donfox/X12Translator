...
defmodule X12Translator.BatchProcessor do
  @moduledoc """
  ...
  alias X12Translator.OutputWriter
  ...
  defp get_config(opts) do
    app_config = normalize_config(Application.get_env(:x12_translator, :batch_processor, %{}))
  ...
  defp get_hot_folder_config(opts) do
    app_config = normalize_config(Application.get_env(:x12_translator, :batch_hot_folder, %{}))
