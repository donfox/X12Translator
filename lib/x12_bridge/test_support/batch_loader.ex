defmodule X12Bridge.TestSupport.BatchLoader do
  ...
  ## Examples
      ...
      batch.batch_id        # "batch_quick_001"
      batch.total_files     # 5
      ...
      # Get specific files
      content = BatchLoader.get_file_content("batch_quick", "001_837p_valid.x12")
  """

  @batches_dir "priv/test_data/batches"
  ...
  ## Examples
      ...
      {:ok, batch} = load_batch("batch_quick")
  ...
  ## Examples
      ...
      # ["batch_quick", "batch_realistic", "batch_performance"]
  """
  def list_batches do
  ...
  ## Examples
      ...
      content = get_file_content("batch_quick", "001_837p_valid.x12")
  """
  ...
  ## Examples
      ...
      {:ok, manifest} = load_manifest("batch_quick")
